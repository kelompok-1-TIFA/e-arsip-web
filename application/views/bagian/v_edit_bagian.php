                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                      <div class="form-group has-default">
                                          ...
                                          <input type="hidden" name="kepala bagian" value="<?php echo $id_bagian ?>" placeholder="Masukkan bagian..." class="form-control" required>
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo $bagian ?>" placeholder="Masukkan data bagian..." name="bagian" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
