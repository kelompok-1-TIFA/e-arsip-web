            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url() ?>laporan_surat_masuk/laporan_bulanan" method="POST">
                                <div class="row mt-4 mb-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <a href="<?php echo base_url() ?>laporan_surat_masuk/laporan_bulanan_print?bulan=<?php echo $bulan ?>&tahun=<?php echo $tahun ?>" target="_blank" class="btn btn-info btn-sm"><i class="material-icons">print</i> Print</a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
