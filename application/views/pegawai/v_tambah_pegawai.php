                        ...
                        <form method="POST" action="<?php echo base_url($this->uri->segment(1).'/simpan') ?>" class="form-horizontal">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                      <div class="form-group has-default">
                                          <input type="text" name="nip" placeholder="Masukkan bagian..." class="form-control" required>
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                      <div class="form-group has-default">
                                          <input type="text" name="nama" placeholder="Masukkan bagian..." class="form-control" required>
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
